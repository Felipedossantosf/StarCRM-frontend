                ...
                {filteredClients.map((cliente, index) => (
                  <tr key={cliente.id} className={index % 2 === 0 ? "bg-white" : "bg-gray-100"}>
                    <td className="px-4 py-2 border-b border-gray-300">
                      <Link to={`/clientes/${cliente.id}`} className="flex items-center">
                        <b>{cliente.nombre}</b>
                        <svg
                          className="h-6 ml-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <td className="px-4 py-2 border-b border-gray-300">
                      <div className="flex items-center space-x-2">
                        <span>Última carga: {cliente.fechaUltCarga || "--"}</span>
